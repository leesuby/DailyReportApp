...
class ViewController: UIViewController {
    ...
    private var copyrightTextView : UITextView = {
    ...
    private var textViewLoginBox: UITextView = {
        let textView = UITextView()
        textView.contentMode = .center
        textView.isEditable = false
        textView.text = "Login"
    ...
    private var forgotTextView : UITextView = {
        ...
        textView.font = UIFont.latoRegular(size: 15)
    ...
    override func viewDidLayoutSubviews() {
        if (isInitial){
            ...
            NSLayoutConstraint(item: forgotTextView, attribute: .leading, relatedBy: .equal, toItem: loginBox, attribute: .centerX, multiplier: 1.0, constant: 0).isActive = true
